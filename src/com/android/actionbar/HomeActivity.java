...
import com.android.actionbar.library.ActionBar;
import com.android.actionbar.library.ActionBar.Action;
import com.android.actionbar.library.ActionBar.IntentAction;
...
public class HomeActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Action otherAction = new IntentAction(this, new Intent(this, OtherActivity.class),
			...
			public void onClick(View view) {
				actionBar.addAction(new Action() {
					...
					public void performAction(View view) {
						Toast.makeText(HomeActivity.this, "Added action.", Toast.LENGTH_SHORT)
								.show();
					}
